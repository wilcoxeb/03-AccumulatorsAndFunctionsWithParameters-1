...
def draw_circles1():
    ...
    for k in range(21):
        radii = radii + 10
        circle = rg.Circle(rg.Point(200, 200), radii)
...
def draw_circles2():
    ...
    for k in range(18):
        point = point + 20
        circle = rg.Circle(rg.Point(point, 100), 10)
...
def draw_circles3():
    ...
    for k in range(100):
        radii = radii + 1
        circle = rg.Circle(rg.Point(200, 150), radii)
...
def draw_cosines_and_sines():
    ...
    for k in range(100):
        pointx = math.cos(k) * 80
        pointy = math.sin(k) * 80
        circle = rg.Circle(rg.Point(pointx + 200, pointy + 200), 10)
